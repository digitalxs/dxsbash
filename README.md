...
\<div align="center"\>
\<img src="[https://www.debian.org/logos/openlogo-nd-100.png](https://www.debian.org/logos/openlogo-nd-100.png)" alt="Debian Logo" width="80"\>
    \<a href="[https://digitalxs.ca](https://digitalxs.ca)"\>
        \<img src="[https://blog.digitalxs.ca/wp-content/uploads/2023/11/cropped-logo300\_1-1.png](https://blog.digitalxs.ca/wp-content/uploads/2023/11/cropped-logo300_1-1.png)" alt="DXSBash Logo" width="80"\>\</a\>

\<h3\>Professional Shell Environment for Linux Power Users on Debian 13\</h3\>
...
\<a href="[https://www.buymeacoffee.com/digitalxs](https://www.buymeacoffee.com/digitalxs)" target="\_blank"\>\<img src="[https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png](https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png)" alt="Buy Me A Coffee" height="45"\>\</a\>
...
\<div align="center"\>
\<img src="preview.png" alt="DXSBash Preview"\>
\</div\>
...
Tested extensively on Debian 13. Please test on any system and send e-mail with detailed info with results, bugs, etc...
  ...
  - For customizations, edit the appropriate shell config and document changes in https://www.google.com/search?q=commands.md. 
...
For a comprehensive list of all available commands and aliases in DXSBash, see the [Commands Reference](https://www.google.com/search?q=commands.md).
