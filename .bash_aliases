...
# GENERAL ALIAS'S
#######################################################
# To temporarily bypass an alias, we precede the command with a \#!/bin/bash
#
...
# Python testing (prefer pytest over deprecated nose)
if command -v pytest &> /dev/null; then
    ...
    echo "Note: pytest not found. Consider installing it: pip install pytest"
fi

# Django shortcuts (only if manage.py exists)
...
alias 777='echo "WARNING: 777 permissions are a security risk. Use: set_permissions 755 <target> for most cases"'
